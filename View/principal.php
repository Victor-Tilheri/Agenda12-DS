...
<body class="w3-light-grey">
    ...
    <header class="w3-container w3-padding-32 w3-center " id="home">
        <h1>
            <img src="../Img/Enlatados.png" alt="Logo" class="w3-image" width="15%">
            </br>
        </h1>
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
            ...
            <form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtNome" type="text" placeholder="00/00/0000" value="">
                    </div>
                </div>
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="formacao">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
                <div class="w3-row w3-center">
                    ...
                    <div class="w3-rest" style="">Data Final</div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    </div> <!-- fecha div interna -->
                </div> <!-- fecha w3-row w3-section -->
            </form>
